...
package scrypttest.jni;

/**
 * {@code LibraryLoaders} will create the appropriate {@link scrypttest.jni.LibraryLoader} for
...
public class LibraryLoaders {
    /**
     * Create a new {@link scrypttest.jni.LibraryLoader} for the current VM.
     *
     * @return the loader.
     */
